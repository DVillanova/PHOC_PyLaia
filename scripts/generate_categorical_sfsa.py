...
with open(symbols_file_path, 'r') as symbols_file:
    for l in symbols_file.readlines():
        ...
        if "<" in symbol:
            if symbol == "<eps>" or symbol == "<space>" or symbol == "<s>" or symbol == "</s>" or symbol == "<DUMMY>":
...
for symbol in normal_symbols:
    out_str = "0 0 {} {} {}\n".format(symbol, symbol, default_weight)
    output_file.write(out_str)

for r in range(1,len(ne_set)):
    ...
    for state in perm:
        ...
        out_str = "{} {} {} {} {}\n".format(prev_state_id, state_id, trans_ne, trans_ne, default_weight)
        output_file.write(out_str)

        out_str = "{} {} {} {} {}\n".format(state_id, prev_state_id, closing_trans_ne, closing_trans_ne, default_weight)
        output_file.write(out_str)

        #Transitions with normal symbols
        for symbol in normal_symbols:
            out_str = "{} {} {} {} {}\n".format(state_id, state_id, symbol, symbol, default_weight)
            output_file.write(out_str)
