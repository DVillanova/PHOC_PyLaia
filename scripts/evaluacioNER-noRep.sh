...
Aciertos_place=$(for f in $2/*.txt; do
...
Aciertos_pers=$(for f in $2/*.txt; do
...
Aciertos_date=$(for f in $2/*.txt; do
...
Aciertos_org=$(for f in $2/*.txt; do
