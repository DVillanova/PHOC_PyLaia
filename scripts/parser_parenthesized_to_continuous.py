...
index_input_file = open(path_index_input_file, 'r', encoding='utf-8')

path_index_output_file = sys.argv[2]
index_output_file = open(path_index_output_file, 'w', encoding='utf-8')
...
for line in index_input_file.readlines():
    ...
    for w in text_line_split:
        ...
        #Any other word / symbol
            ...
            tags = "".join([tag_ne for tag_ne in reversed(stack_opened_ne)]).strip()
            ...
            if added_tags:
                ...
                transformed_text_line = transformed_text_line + w + " "
