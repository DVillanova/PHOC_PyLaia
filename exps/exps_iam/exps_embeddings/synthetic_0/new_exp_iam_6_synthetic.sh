...
TextDir=${HomeDataDir}/6_NOT_PARENTHESIZED_TEXT
LangDir=${HomeDataDir}/6_NOT_PARENTHESIZED_lang
CharDir=${LangDir}/char
ModelDir=${HomeDataDir}/6_NOT_PARENTHESIZED_model
ConllModelDir=${HomeDataDir}/../conll2003/BASELINE_SYNTHETIC_model
TmpDir=${HomeDataDir}/6_NOT_PARENTHESIZED_TMP
...
nice pylaia-htr-decode-ctc \
  --common.train_path ${ModelDir} \
  --common.model_filename model \
  --common.checkpoint ${ModelDir}/experiment/epoch=301-lowest_va_ecer.ckpt \
  --logging.level INFO \
  --logging.to_stderr_level INFO \
