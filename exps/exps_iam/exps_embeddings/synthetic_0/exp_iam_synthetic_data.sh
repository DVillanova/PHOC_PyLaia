...
DataDir=/data/dvillano/iam/DATA
TextDir=${HomeDataDir}/6_SYNTHETIC_TEXT
LangDir=${HomeDataDir}/6_SYNTHETIC_LANG
CharDir=${LangDir}/char
ModelDir=${HomeDataDir}/6_SYNTHETIC_model
TmpDir=${HomeDataDir}/6_SYNTHETIC_TMP
