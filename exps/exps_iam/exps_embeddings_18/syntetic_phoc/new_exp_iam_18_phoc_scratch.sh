...
TextDir=${HomeDataDir}/SCRATCH_18_PHOC_TEXT
LangDir=${HomeDataDir}/SCRATCH_18_PHOC_TEXT
CharDir=${LangDir}/char
ModelDir=${HomeDataDir}/SCRATCH_18_PHOC_model
TmpDir=${HomeDataDir}/SCRATCH_18_PHOC_TMP
...
nice pylaia-htr-decode-ctc \
  --common.train_path ${ModelDir} \
  --common.model_filename model \
  --common.checkpoint ${ModelDir}/experiment/epoch=399-lowest_va_ecer.ckpt \
  --logging.level INFO \
  --logging.to_stderr_level INFO \
...
ie-eval all --label-dir ${TmpDir}/bio_labels/ --prediction-dir ${TmpDir}/decode/bio_labels/ > ${HomeDataDir}/results_18_phoc_scratch.txt

ie-eval nerval --label-dir ${TmpDir}/bio_labels/ \
--prediction-dir ${TmpDir}/decode/bio_labels/ \
>> ${HomeDataDir}/results_18_phoc_scratch.txt

cat $HomeDataDir/results_18_phoc_scratch.txt
...
python $ScriptsDir/compute-cer_wer.py $TmpDir/test_no_tags.txt $TmpDir/decode/wordtest_no_tags.txt >> $HomeDataDir/results_18_phoc_scratch.txt
cat $HomeDataDir/results_18_phoc_scratch.txt
...
#Evaluation
echo "\n\nWith 6-gram character LM" >> $HomeDataDir/results_18_phoc_scratch.txt
...
$TmpDir/decode/with_char_lm/wordtest_no_tags.txt >> $HomeDataDir/results_18_phoc_scratch.txt
cat $HomeDataDir/results_18_phoc_scratch.txt