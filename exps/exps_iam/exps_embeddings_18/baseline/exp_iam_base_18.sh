...
TextDir=${HomeDataDir}/18_NOT_PARENTHESIZED_TEXT
LangDir=${HomeDataDir}/18_NOT_PARENTHESIZED_lang
CharDir=${LangDir}/char
ModelDir=${HomeDataDir}/18_NOT_PARENTHESIZED_model
TmpDir=${HomeDataDir}/18_NOT_PARENTHESIZED_TMP
...
python $ScriptsDir/IAM_generate_tagged_line_transcription.py 3 \
       $HomeDataDir/ne_annotations/iam_all_custom_18_all.txt $DataDir/ascii/lines.txt \
       $TextDir/index.words
...
sed -i 's/<CARDINAL>//g' $TmpDir/decode/wordtest_no_tags.txt
sed -i 's/<DATE>//g' $TmpDir/decode/wordtest_no_tags.txt
sed -i 's/<EVENT>//g' $TmpDir/decode/wordtest_no_tags.txt
sed -i 's/<FAC>//g' $TmpDir/decode/wordtest_no_tags.txt
sed -i 's/<GPE>//g' $TmpDir/decode/wordtest_no_tags.txt
sed -i 's/<LANGUAGE>//g' $TmpDir/decode/wordtest_no_tags.txt
sed -i 's/<LAW>//g' $TmpDir/decode/wordtest_no_tags.txt
sed -i 's/<LOCATION>//g' $TmpDir/decode/wordtest_no_tags.txt
sed -i 's/<MONEY>//g' $TmpDir/decode/wordtest_no_tags.txt
sed -i 's/<NORP>//g' $TmpDir/decode/wordtest_no_tags.txt
sed -i 's/<ORDINAL>//g' $TmpDir/decode/wordtest_no_tags.txt
sed -i 's/<ORG>//g' $TmpDir/decode/wordtest_no_tags.txt
sed -i 's/<PERCENT>//g' $TmpDir/decode/wordtest_no_tags.txt
sed -i 's/<PER>//g' $TmpDir/decode/wordtest_no_tags.txt
sed -i 's/<PRODUCT>//g' $TmpDir/decode/wordtest_no_tags.txt
sed -i 's/<QUANTITY>//g' $TmpDir/decode/wordtest_no_tags.txt
sed -i 's/<TIME>//g' $TmpDir/decode/wordtest_no_tags.txt
sed -i 's/<WORK_OF_ART>//g' $TmpDir/decode/wordtest_no_tags.txt
...
sed -i 's/<CARDINAL>//g' $TmpDir/test_no_tags.txt
sed -i 's/<DATE>//g' $TmpDir/test_no_tags.txt
sed -i 's/<EVENT>//g' $TmpDir/test_no_tags.txt
sed -i 's/<FAC>//g' $TmpDir/test_no_tags.txt
sed -i 's/<GPE>//g' $TmpDir/test_no_tags.txt
sed -i 's/<LANGUAGE>//g' $TmpDir/test_no_tags.txt
sed -i 's/<LAW>//g' $TmpDir/test_no_tags.txt
sed -i 's/<LOCATION>//g' $TmpDir/test_no_tags.txt
sed -i 's/<MONEY>//g' $TmpDir/test_no_tags.txt
sed -i 's/<NORP>//g' $TmpDir/test_no_tags.txt
sed -i 's/<ORDINAL>//g' $TmpDir/test_no_tags.txt
sed -i 's/<ORG>//g' $TmpDir/test_no_tags.txt
sed -i 's/<PERCENT>//g' $TmpDir/test_no_tags.txt
sed -i 's/<PER>//g' $TmpDir/test_no_tags.txt
sed -i 's/<PRODUCT>//g' $TmpDir/test_no_tags.txt
sed -i 's/<QUANTITY>//g' $TmpDir/test_no_tags.txt
sed -i 's/<TIME>//g' $TmpDir/test_no_tags.txt
sed -i 's/<WORK_OF_ART>//g' $TmpDir/test_no_tags.txt
...
#####################################
#Merge IAM train and validation into a single file
...
img_dirs=$(cat $WorkDir/exps/new_lines_dirs.txt)
...
sed -i 's/<CARDINAL>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
sed -i 's/<DATE>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
sed -i 's/<EVENT>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
sed -i 's/<FAC>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
sed -i 's/<GPE>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
sed -i 's/<LANGUAGE>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
sed -i 's/<LAW>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
sed -i 's/<LOCATION>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
sed -i 's/<MONEY>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
sed -i 's/<NORP>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
sed -i 's/<ORDINAL>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
sed -i 's/<ORG>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
sed -i 's/<PERCENT>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
sed -i 's/<PER>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
sed -i 's/<PRODUCT>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
sed -i 's/<QUANTITY>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
sed -i 's/<TIME>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
sed -i 's/<WORK_OF_ART>//g' $TmpDir/decode/with_char_lm/wordtest_no_tags.txt
